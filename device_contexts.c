...
void ddt_init()
{
    ...
    root_ddt[1] = (((uintptr_t)s2pt_root) >> 12) | (IOHGATP_MODE);  // DC.iohgatp
    root_ddt[2] = 0;                                                // DC.ta
    root_ddt[3] = (((uintptr_t)s1pt) >> 12) | (IOSATP_MODE);        // DC.fsc
    root_ddt[4] = (((uintptr_t)msi_pt) >> 12) | (MSIPTP_MODE);      // DC.msiptp

...
uintptr_t idma_src[N_DMA] = {
    ...
    IDMA_REG_ADDR(4, IDMA_SRC_ADDR_OFF),
    IDMA_REG_ADDR(5, IDMA_SRC_ADDR_OFF),
    IDMA_REG_ADDR(6, IDMA_SRC_ADDR_OFF),
    IDMA_REG_ADDR(7, IDMA_SRC_ADDR_OFF)
};
...
uintptr_t idma_dest[N_DMA] = {
    ...
    IDMA_REG_ADDR(4, IDMA_DEST_ADDR_OFF),
    IDMA_REG_ADDR(5, IDMA_DEST_ADDR_OFF),
    IDMA_REG_ADDR(6, IDMA_DEST_ADDR_OFF),
    IDMA_REG_ADDR(7, IDMA_DEST_ADDR_OFF)
};
...
uintptr_t idma_nbytes[N_DMA] = {
    ...
    IDMA_REG_ADDR(4, IDMA_N_BYTES_OFF),
    IDMA_REG_ADDR(5, IDMA_N_BYTES_OFF),
    IDMA_REG_ADDR(6, IDMA_N_BYTES_OFF),
    IDMA_REG_ADDR(7, IDMA_N_BYTES_OFF)
};
...
uintptr_t idma_config[N_DMA] = {
    ...
    IDMA_REG_ADDR(4, IDMA_CONFIG_OFF),
    IDMA_REG_ADDR(5, IDMA_CONFIG_OFF),
    IDMA_REG_ADDR(6, IDMA_CONFIG_OFF),
    IDMA_REG_ADDR(7, IDMA_CONFIG_OFF)
};
...
uintptr_t idma_status[N_DMA] = {
    ...
    IDMA_REG_ADDR(4, IDMA_STATUS_OFF),
    IDMA_REG_ADDR(5, IDMA_STATUS_OFF),
    IDMA_REG_ADDR(6, IDMA_STATUS_OFF),
    IDMA_REG_ADDR(7, IDMA_STATUS_OFF)
};
uintptr_t idma_nextid[N_DMA] = {
    ...
    IDMA_REG_ADDR(4, IDMA_NEXT_ID_OFF),
    IDMA_REG_ADDR(5, IDMA_NEXT_ID_OFF),
    IDMA_REG_ADDR(6, IDMA_NEXT_ID_OFF),
    IDMA_REG_ADDR(7, IDMA_NEXT_ID_OFF)
};
...
uintptr_t idma_done[N_DMA] = {
    ...
    IDMA_REG_ADDR(4, IDMA_DONE_OFF),
    IDMA_REG_ADDR(5, IDMA_DONE_OFF),
    IDMA_REG_ADDR(6, IDMA_DONE_OFF),
    IDMA_REG_ADDR(7, IDMA_DONE_OFF)
};
...
uintptr_t idma_ipsr[N_DMA] = {
    ...
    IDMA_REG_ADDR(4, IDMA_IPSR_OFF),
    IDMA_REG_ADDR(5, IDMA_IPSR_OFF),
    IDMA_REG_ADDR(6, IDMA_IPSR_OFF),
    IDMA_REG_ADDR(7, IDMA_IPSR_OFF)
};
